  ...
  return (
    <div className='skill section__padding'>
      ...
      <div className='skill-content'>
        ...
        <a href="https://nextjs.org/docs" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/nextjs-colored-dark.svg" width="70" height="70" alt="NextJs" /></a>
        ...
        <a href="https://expressjs.com/" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/express-colored-dark.svg" width="70" height="70" alt="Express" /></a>
        ...
        <Link href="https://github.com/shabrina12">
          <FaGithub className='icon' size={80} />
        </Link>
      </div>
    </div>
  )
